        ...
        stage ('Deployments'){
            parallel{
                stage ('Deploy to Staging'){
                    steps {
                        bat "C:\\scp -i C:\\\\id.ppk **/target/*.war pi@${params.tomcat_dev}:/usr/share/tomcat/webapps"
                        bat "C:\\scp -i C:\\id.ppk **/target/*.war pi@${params.tomcat_qa}:/usr/share/tomcat/webapps"
                    }
                }
